...
for index,value in enumerate(x):
    ...
    list.append(tmp)
raw = np.array(list)
result = KMeans(n_clusters=8).fit_predict(raw)
cen0x = []
cen0y = []
cen1x = []
cen1y = []
...
for index,value in enumerate(result):
    ...
    if int(tmpc) == 7:
        cen7x.append(float(tmpx))
        cen7y.append(float(tmpy))
...
center7x = averagenum(cen7x)
center7y = averagenum(cen7y)
#centerlist = [[center0x,center0y],[center1x,center1y],[center2x,center2y],[center3x,center3y]]
#centerlist = [[center0x,center0y],[center1x,center1y],[center2x,center2y],[center3x,center3y],[center4x,center4y]]
#centerlist = [[center0x,center0y],[center1x,center1y],[center2x,center2y],[center3x,center3y],[center4x,center4y],[center5x,center5y]]
...
centerlist = [[center0x,center0y],[center1x,center1y],[center2x,center2y],[center3x,center3y],[center4x,center4y],[center5x,center5y],[center6x,center6y],[center7x,center7y]]
...
print("Calinski score by 8 classes:")
